# docs — durable rules and reference (factory)

Short files, one topic each. This is *knowledge* (what is true for this project), changed by PR. It is not a place for task notes (PRs), architecture facts already stated by a `CONTEXT.md` next to code, or decisions (those are ADRs in `decisions/`).
